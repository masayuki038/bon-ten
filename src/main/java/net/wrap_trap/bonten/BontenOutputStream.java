...
public class BontenOutputStream implements AutoCloseable {
  ...
  public void writeUnsignedInt(final long l) throws IOException {
    // write last 4bytes
    this.internal.writeInt((int) l);
  }

  public void writeUnsignedShort(final int i) throws IOException {
    // write last 2bytes
    this.internal.writeShort(i);
  }

  public void writeUnsignedLong(final BigInteger b) throws IOException {
    // write last 8bytes
